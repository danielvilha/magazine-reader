...
// in simulator we redefine to format for MagazineReader Developer console
...
{\
	NSString * exceptionName = [@"org.magazinereader." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.magazinereader";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIMagazineReaderNativeItemNone = -1, 
	UIMagazineReaderNativeItemSpinner = -2,
	UIMagazineReaderNativeItemProgressBar = -3,
	
	UIMagazineReaderNativeItemSlider = -4,
	UIMagazineReaderNativeItemSwitch = -5,
	UIMagazineReaderNativeItemMultiButton = -6,
	UIMagazineReaderNativeItemSegmented = -7,
	
	UIMagazineReaderNativeItemTextView = -8,
	UIMagazineReaderNativeItemTextField = -9,
	UIMagazineReaderNativeItemSearchBar = -10,
	
	UIMagazineReaderNativeItemPicker = -11,
	UIMagazineReaderNativeItemDatePicker = -12,
	
	UIMagazineReaderNativeItemInfoLight = -13,
	UIMagazineReaderNativeItemInfoDark = -14,
	
	UIMagazineReaderNativeItemDisclosure = -15,
	
	UIMagazineReaderNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all MagazineReader instances of
