...
//@interface MagazineReaderObject : NSObject
//@end

@interface MagazineReaderObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MagazineReaderObject class]])
		{
			for (NSString *key in [[(MagazineReaderObject*)o modules] allKeys])
			{
