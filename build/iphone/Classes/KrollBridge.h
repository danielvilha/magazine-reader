...
@interface MagazineReaderObject : KrollCoverageObject {
#else
@interface MagazineReaderObject : KrollObject {
#endif
@private
...
extern NSString * MagazineReader$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	MagazineReaderObject *_magazinereader;
    KrollObject* console;
	BOOL shutdown;
