...
/**
 The base class for all MagazineReader modules
 */
...
/**
 MagazineReader Platform calls this method on startup.
 */
-(void)startup;

/**
 MagazineReader Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 MagazineReader Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 MagazineReader Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 MagazineReader Platform calls this method on resume.
 @param sender The sender of the event.
 */
