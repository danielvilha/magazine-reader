...
//Rare exceptions to indicate a bug in the _magazinereader code (Eg, function that a subclass should have implemented)
...
/**
 The base class for MagazineReader proxies.
 */
