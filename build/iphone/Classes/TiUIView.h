...
/**
 Base class for all MagazineReader views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the MagazineReader view hierarchy (such as wrapped iOS UIViews) was touched.
